  ...
  return (
    <>
        <div
          ...
          hover:bg-gray-100 ${
            isDragActive ? 'border-indigo-500 bg-indigo-100' : 'border-gray-400'
          }`}>
    ...
    {/*
      <div className='border border-indigo-100 bg-indigo-50 rounded-md px-4 py-4'>
        <h1 className="font-bold text-2xl text-indigo-500">Upload a Resume</h1>
